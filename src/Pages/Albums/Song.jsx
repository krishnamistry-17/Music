...
const Song = ({ onAddSong, playlistSongs }) => {
  ...
  const albumNames = {
    "6864de81b5cb32f97e53b1b4": "My Special Album",
    anotherAlbumId: "Chill Beats Vol. 2",
    // add more if needed
  };

  const albumName = isAuthenticated
    ? filteredAlbum?.[0]?.name || albumNames[id] || "Unknown Album"
    : "Guest Default Album";
